...
def batchify_with_label(input_batch_list, gpu, volatile_flag=False):
    ...
    if gpu:
        word_seq_tensor = word_seq_tensor.cuda(0)
        biword_seq_tensor = biword_seq_tensor.cuda(0)
        word_seq_lengths = word_seq_lengths.cuda(0)
        word_seq_recover = word_seq_recover.cuda(0)
        label_seq_tensor = label_seq_tensor.cuda(0)
        char_seq_tensor = char_seq_tensor.cuda(0)
        char_seq_recover = char_seq_recover.cuda(0)
        mask = mask.cuda(0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="data/model/weibo.")
    ...
    # parser.add_argument('--train', default="data/msra_train_bio.txt")
    # parser.add_argument('--dev', default="data/msra_test_bio.txt")
    # parser.add_argument('--test', default="data/msra_test_bio.txt")
